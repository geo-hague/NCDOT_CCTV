...
async function updateMilepostAndDirection(lat, lon) {
  ...
  // NCDOT doesn't mile-mark at this particular spot (e.g. I-40/I-85: the
  ...
  // — e.g. I-85 between Gastonia and Charlotte is signed "northbound" the
  // whole way, but the road there physically runs east-southeast, which a
  // bearing-only check would read as southbound. Mile markers always
