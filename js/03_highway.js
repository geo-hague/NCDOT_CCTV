...
// genuine long Interstate-Interstate multiplex (e.g. I-40/I-85, both
...
// arbitrarily tie-break I-40 vs I-85 by array order, which is exactly
...
async function updateMilepostAndDirection(lat, lon) {
  ...
  const withMeta = features.map(f => {
    ...
    const dist = (a.Latitude != null && a.Longitude != null)
      ...
      : Infinity;
    return { mp, dist, lat: a.Latitude, lon: a.Longitude, routeName: a.RouteName, direction: a.RouteDirection || null };
  });
